...
const ListRoomsTypeStatusMaintainScreen = function ({navigation}) {
  ...
  return (
    <View>
      ...
      <View style={ListRoomsStyle.filter}>
          ...
          <Picker.Item label="Rooms Maintaining" selected value="3" />
...
export default ListRoomsTypeStatusMaintainScreen;
